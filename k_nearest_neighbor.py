...
class KNearestNeighbor:
    ...
    def compute_distances_two_loops(self, X):
        ...
        for i in range(num_test):
            for j in range(num_train):
                ...
                #dists[i, j] = (num_test[i] ** 2 + num_train[j] ** 2) ** (1 / 2);
    ...
    def compute_distances_one_loop(self, X):
        ...
        for i in range(num_test):
            ...
            dists[i, :] = np.sqrt(np.square(dif).sum(axis=1))
            # *****END OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
        return dists
    ...
    def compute_distances_no_loops(self, X):
        ...
        dists = np.sqrt(norm - 2.0 * X.dot(self.X_train.T) + train_norm)
        # *****END OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
        return dists
    ...
    def predict_labels(self, dists, k=1):
        ...
        for i in range(num_test):
            ...
            #########################################################################
            # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
            variables, counts = np.unique(k_closest_y, return_counts=True)
            y_pred[i] = variables[np.argmax(counts)]
            # *****END OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
